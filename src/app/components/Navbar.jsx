...
export default function Navbar() {
    ...
    return (
        <nav className="flex filter relative  drop-shadow-xl transparent  h-20 items-center  ">
            <div className='flex filter  w-screen rounded-full mx-6 px-4 py-4 bg-[conic-gradient(at_top_left,_var(--tw-gradient-stops))] from-indigo-200 via-slate-600 to-indigo-200'>
